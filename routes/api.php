...
Route::group([
    'middleware' => 'api',
    'prefix' => 'topbanners',
    'controller' => TopBannerController::class
], function ($router) {
    Route::get('', 'index');
    Route::get('/{topbanner}', 'show');
    Route::post('', 'create');
    Route::put('/{topbanner}', 'update');
    Route::delete('/{topbanner}', 'destroy');
    Route::get('/{topbanner}/restore', 'restore');
    Route::get('/{topbanner}/position/{action}', 'position');
    Route::get('/{topbanner}/active/{is_active}', 'setActive');
});
Route::group([
    'middleware' => 'api',
    'prefix' => 'news',
